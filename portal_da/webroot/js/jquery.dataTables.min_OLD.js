...
(function(k) {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Documento não encontrado ou não existem dívidas para este documento",
            sInfo: "Mostrando _START_ de _END_ do total de _TOTAL_ registro(s)",
            sInfoEmpty: "Mostrando 0 de 0 do total de 0 registros",
            sInfoFiltered: "(filtrado do total de _MAX_ registros)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Quantidade registros: _MENU_ ",
