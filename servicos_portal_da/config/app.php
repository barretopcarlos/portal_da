...
return [
    ...
    'App' => [
        ...
        'defaultLocale' => 'pt_BR', // Mudança para o locale do Brasil
        'defaultTimezone' => 'America/Sao_Paulo', // Fuso horário do Brasil
        'base' => false,
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
    ...
    'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            'host' => 'smtp.pge.rj.gov.br',
            'port' => 25,
            'ssl' => true,
            'username' => 'leandrol@pge.rj.gov.br',
            'client' => null,
            'log' => false,
            'context' => null,
        ],
